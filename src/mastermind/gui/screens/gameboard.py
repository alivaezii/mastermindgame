...
class GameBoardScreen(tk.Frame):
    ...
    def _create_widgets(self):
        ...
        info_label = tk.Label(
            header_frame,
            text=f"Player: {self.player_name}  |  Attempt: {self.game.attempts_used + 1}/{self.game.max_attempts}",
            font=("Arial", 16, "bold"),
            bg="#34495E",
            fg="white"
        )
        ...
        help_text = tk.Label(
            header_frame,
            text="● Bulls = Correct color in correct position  |  ○ Cows = Correct color in wrong position",
            font=("Arial", 10),
            bg="#34495E",
            fg="#ECF0F1"
        )
        ...
        history_frame = tk.Frame(content_frame, bg="white", relief=tk.SUNKEN, borderwidth=2)
        ...
        guess_display_frame = tk.Frame(content_frame, bg="white", relief=tk.RAISED, borderwidth=2)
        ...
        picker_frame = tk.Frame(content_frame, bg="white", relief=tk.RAISED, borderwidth=2)
    ...
    def _on_submit(self):
        ...
        try:
            ...
            self._add_guess_to_history(self.current_guess, result["bulls"], result["cows"])
